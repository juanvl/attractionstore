...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { address: @attraction.address, company_id: @attraction.company_id, duration_minutes: @attraction.duration_minutes, max_capacity: @attraction.max_capacity, name: @attraction.name } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { address: @attraction.address, company_id: @attraction.company_id, duration_minutes: @attraction.duration_minutes, max_capacity: @attraction.max_capacity, name: @attraction.name } }
